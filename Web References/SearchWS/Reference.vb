...
Namespace SearchWS
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="QueryServiceSoap", [Namespace]:="http://microsoft.com/webservices/OfficeServer/QueryService")>  _
    Partial Public Class QueryService
        ...
        Private GetPortalSearchInfoOperationCompleted As System.Threading.SendOrPostCallback
        
        Private GetSearchMetadataOperationCompleted As System.Threading.SendOrPostCallback
        
        Private RecordClickOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.SharePointSearchServiceTool.My.MySettings.Default.SharePointSearchServiceTool_SearchWS_QueryService
        ...
        '''<remarks/>
        Public Event GetPortalSearchInfoCompleted As GetPortalSearchInfoCompletedEventHandler
        
        '''<remarks/>
        Public Event GetSearchMetadataCompleted As GetSearchMetadataCompletedEventHandler
        
        '''<remarks/>
        Public Event RecordClickCompleted As RecordClickCompletedEventHandler
        ...
        Public Function GetPortalSearchInfo() As String
            Dim results() As Object = Me.Invoke("GetPortalSearchInfo", New Object(-1) {})
            Return CType(results(0),String)
        End Function
        ...
        Public Overloads Sub GetPortalSearchInfoAsync(ByVal userState As Object)
            If (Me.GetPortalSearchInfoOperationCompleted Is Nothing) Then
                Me.GetPortalSearchInfoOperationCompleted = AddressOf Me.OnGetPortalSearchInfoOperationCompleted
            End If
            Me.InvokeAsync("GetPortalSearchInfo", New Object(-1) {}, Me.GetPortalSearchInfoOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetPortalSearchInfoOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetPortalSearchInfoCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetPortalSearchInfoCompleted(Me, New GetPortalSearchInfoCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        Public Function GetSearchMetadata() As System.Data.DataSet
            Dim results() As Object = Me.Invoke("GetSearchMetadata", New Object(-1) {})
            Return CType(results(0),System.Data.DataSet)
        End Function
        ...
        Public Overloads Sub GetSearchMetadataAsync(ByVal userState As Object)
            If (Me.GetSearchMetadataOperationCompleted Is Nothing) Then
                Me.GetSearchMetadataOperationCompleted = AddressOf Me.OnGetSearchMetadataOperationCompleted
            End If
            Me.InvokeAsync("GetSearchMetadata", New Object(-1) {}, Me.GetSearchMetadataOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetSearchMetadataOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetSearchMetadataCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetSearchMetadataCompleted(Me, New GetSearchMetadataCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("urn:Microsoft.Search/RecordClick", RequestNamespace:="urn:Microsoft.Search", ResponseNamespace:="urn:Microsoft.Search", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Sub RecordClick(ByVal clickInfoXml As String)
            Me.Invoke("RecordClick", New Object() {clickInfoXml})
        End Sub
        ...
        Public Overloads Sub RecordClickAsync(ByVal clickInfoXml As String, ByVal userState As Object)
            If (Me.RecordClickOperationCompleted Is Nothing) Then
                Me.RecordClickOperationCompleted = AddressOf Me.OnRecordClickOperationCompleted
            End If
            Me.InvokeAsync("RecordClick", New Object() {clickInfoXml}, Me.RecordClickOperationCompleted, userState)
        End Sub
        
        Private Sub OnRecordClickOperationCompleted(ByVal arg As Object)
            If (Not (Me.RecordClickCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent RecordClickCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433")>  _
    Public Delegate Sub GetPortalSearchInfoCompletedEventHandler(ByVal sender As Object, ByVal e As GetPortalSearchInfoCompletedEventArgs)
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433")>  _
    Public Delegate Sub GetSearchMetadataCompletedEventHandler(ByVal sender As Object, ByVal e As GetSearchMetadataCompletedEventArgs)
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433")>  _
    Public Delegate Sub RecordClickCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
End Namespace
